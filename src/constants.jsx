...
export const MOCK_PRODUCTS = [
  // KOI COLLECTION
  {
    ...
    description:
      "Fluid designs inspired by Japanese artistry. These earrings capture the rhythmic flow of water and the bold presence of the Koi.",
  },
  {
    id: "k2",
...
export const MOCK_JOURNAL_ENTRIES = [
  {
    ...
    excerpt:
      "Discover the secrets to styling your favorite pieces together. From mixing metals to balancing proportions, elevate your everyday look with our comprehensive guide to layering jewelry.",
  ...
  },
  {
    ...
    excerpt:
      "Step into our atelier and witness the craftsmanship behind our signature collection. See how Japanese artistry inspires every fluid curve and gemstone setting.",
  ...
  },
  {
    ...
    excerpt:
      "Preserve the brilliance of your heirloom pieces. Expert tips on cleaning, storing, and maintaining gold, diamonds, and precious gemstones for generations to come.",
  ...
  },
  {
    ...
    excerpt:
      "Why this romantic metal is making a major comeback. We explore the versatility of rose gold and how it complements every skin tone and style palette.",
